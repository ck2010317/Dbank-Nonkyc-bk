...
export function CardVisual({
  ...
  return (
    <div className="relative w-full max-w-[400px] aspect-[1.6/1] rounded-2xl bg-gradient-to-br from-primary via-primary/90 to-primary/70 p-4 md:p-5 shadow-2xl overflow-hidden">
      ...
      <div className="relative h-full flex flex-col text-white z-10">
        ...
        <div className="flex items-end justify-between gap-3 mt-auto pb-1">
          ...
          <div className="flex gap-3 md:gap-4 flex-shrink-0 items-end">
            <div className="text-right">
              <p className="text-[10px] md:text-xs text-white/90 mb-0.5 leading-none whitespace-nowrap">Expires</p>
              <p className="text-xs md:text-sm font-mono text-white font-bold leading-tight whitespace-nowrap">
                {expiryDate}
              </p>
            </div>
            <div className="text-right">
              <p className="text-[10px] md:text-xs text-white/90 mb-0.5 leading-none whitespace-nowrap">CVV</p>
