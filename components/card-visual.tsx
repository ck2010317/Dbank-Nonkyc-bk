...
export function CardVisual({
  ...
  return (
    <div className="relative w-full max-w-[400px] aspect-[1.8/1] rounded-2xl bg-gradient-to-br from-primary via-primary/90 to-primary/70 p-4 md:p-6 shadow-2xl overflow-hidden">
      ...
      <div className="relative h-full flex flex-col text-white z-10">
        ...
        <div className="flex items-start justify-between gap-3 mt-auto pb-4 md:pb-3">
          <div className="flex-shrink min-w-0 max-w-[40%]">
            <p className="text-xs md:text-sm text-white/90 mb-2 leading-tight">Card Holder</p>
          ...
          <div className="flex gap-4 md:gap-6 flex-shrink-0">
            <div className="text-right">
              <p className="text-xs md:text-sm text-white/90 mb-2 leading-tight whitespace-nowrap">Expires</p>
              <p className="text-sm md:text-base font-mono text-white font-bold leading-tight whitespace-nowrap">
                {expiryDate}
              </p>
            </div>
            <div className="text-right">
              <p className="text-xs md:text-sm text-white/90 mb-2 leading-tight whitespace-nowrap">CVV</p>
              <p className="text-sm md:text-base font-mono text-white font-bold leading-tight whitespace-nowrap">
                {cvv}
              </p>
            </div>
