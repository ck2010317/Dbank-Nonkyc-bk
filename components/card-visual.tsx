...
export function CardVisual({
  ...
  return (
    <div className="relative w-full max-w-[400px] aspect-[1.7/1] rounded-2xl bg-gradient-to-br from-primary via-primary/90 to-primary/70 p-5 md:p-6 shadow-2xl overflow-hidden">
      ...
      <div className="relative h-full flex flex-col text-white z-10">
        ...
        <div className="flex items-end justify-between gap-3 mt-auto">
          <div className="flex-shrink min-w-0 max-w-[45%]">
            <p className="text-[10px] md:text-xs text-white/90 mb-1 leading-none">Card Holder</p>
          ...
          <div className="flex gap-4 md:gap-6 flex-shrink-0 items-end">
            <div className="text-right">
              <p className="text-[10px] md:text-xs text-white/90 mb-1 leading-none whitespace-nowrap">Expires</p>
              <p className="text-sm md:text-base font-mono text-white font-bold leading-tight whitespace-nowrap">
                {expiryDate}
              </p>
            </div>
            <div className="text-right">
              <p className="text-[10px] md:text-xs text-white/90 mb-1 leading-none whitespace-nowrap">CVV</p>
              <p className="text-sm md:text-base font-mono text-white font-bold leading-tight whitespace-nowrap">
                {cvv}
              </p>
            </div>
