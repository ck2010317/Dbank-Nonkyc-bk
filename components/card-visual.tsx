...
export function CardVisual({
  ...
  return (
    <div className="relative w-full max-w-[400px] min-h-0 aspect-[1.8/1] rounded-2xl bg-gradient-to-br from-primary via-primary/90 to-primary/70 p-5 md:p-6 shadow-2xl overflow-hidden">
      ...
      <div className="relative h-full flex flex-col text-white z-10">
        ...
        {/* Bottom section - Improved spacing and text sizing for Safari */}
        <div className="flex items-end justify-between gap-2 mt-auto pb-1">
